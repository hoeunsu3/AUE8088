...
def run(
    ...
    if save_json and len(jdict):
        ...
        try:
            ...
            if not os.path.exists('utils/eval/KAIST_test_annotation.json'):
            ...
            os.system(f"python3 utils/eval/kaisteval.py --annFile utils/eval/KAIST_test_annotation.json --rstFile {pred_json}")
